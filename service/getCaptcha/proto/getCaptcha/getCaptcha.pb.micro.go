...
type GetCaptchaService interface {
	...
	GetSmscd(ctx context.Context, in *SmscdRequest, opts ...client.CallOption) (*SmscdResponse, error)
}
...
func (c *getCaptchaService) GetSmscd(ctx context.Context, in *SmscdRequest, opts ...client.CallOption) (*SmscdResponse, error) {
	req := c.c.NewRequest(c.name, "GetCaptcha.GetSmscd", in)
	out := new(SmscdResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type GetCaptchaHandler interface {
	...
	GetSmscd(context.Context, *SmscdRequest, *SmscdResponse) error
}
...
func RegisterGetCaptchaHandler(s server.Server, hdlr GetCaptchaHandler, opts ...server.HandlerOption) error {
	type getCaptcha interface {
		...
		GetSmscd(ctx context.Context, in *SmscdRequest, out *SmscdResponse) error
	}
...
func (h *getCaptchaHandler) GetSmscd(ctx context.Context, in *SmscdRequest, out *SmscdResponse) error {
	return h.GetCaptchaHandler.GetSmscd(ctx, in, out)
}
